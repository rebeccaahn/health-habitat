...
async function recommendExerciseTask(category, muscle, equipment) {
    ...
    let exerciseUnion = _.union(categorySnapshot.docs, muscleSnapshot.docs, equipmentSnapshot.docs);
...
async function recommendMeditationTask(tag, duration) {
    ...
    // Uniquely union multiple arrays
    let meditationUnion = _.union(tagSnapshot.docs, durationSnapshot.docs);
